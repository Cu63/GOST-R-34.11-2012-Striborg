...
class GOSTHash {
    ...
    public:
        GOSTHash(unsigned int hashSize = 256);
        void hashX(const uint8_t *a, const uint8_t *b, uint8_t *c);
        void hash512(const uint8_t *a, const uint8_t *b, uint8_t *c);
        void hashS(uint8_t *state);
        void hashP(uint8_t *state);
        void hashL(uint8_t *state);
        void hashGetKey(uint8_t *k, int i);
        void hashE(uint8_t *k, const uint8_t* m, uint8_t *state);
        void hashG(uint8_t *h, uint8_t *N, const uint8_t *m);
        void hashPadding();
        void hashStage2(const uint8_t *data);
        void hashStage3();
        void hashUpdate(const uint8_t *data, size_t len);
        void hashFinal();
        void hashPrint();
        unsigned int getHashSize() { return hashSize; };
        uint8_t *getHash();
        bool compareHash(const uint8_t *h, int n);
};
